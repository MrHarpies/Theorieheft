...
\begin{figure}[h]
	\centering
	\include{Media/logarithmus_dreieck}
    ...
    \begin{subfigure}[b]{3cm}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot coordinates {(0,0) (20,8) (40,10)};
            \end{axis}
        \end{tikzpicture}
        \caption{}
    \end{subfigure}
    \begin{subfigure}[b]{3cm}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot coordinates {(0,0) (10,5) (20,7) (30,8) (40,9)};
            \end{axis}
        \end{tikzpicture}
        \caption{}
    \end{subfigure}
    \begin{subfigure}[b]{3cm}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot coordinates {(0,0) (10,2) (20,4) (30,8) (40,10)};
            \end{axis}
        \end{tikzpicture}
        \caption{}
    \end{subfigure}
    \caption{Drei Graphen nebeneinander}
